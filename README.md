...
📌Overview
This project is a distributed task processing system built using AWS services. It demonstrates how modern scalable systems handle asynchronous workloads using queues and auto scaling.  
...
4. Worker instances poll queue continuously
